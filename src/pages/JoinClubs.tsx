...
export default function JoinClubs() {
  const { session, signOut, accessStatus } = useAuth();
  ...
  return (
    <main className="grid min-h-screen bg-background px-4 py-8 text-foreground">
      <section className="mx-auto grid w-full max-w-lg content-start gap-4">
        <div>
          <h1 className="text-2xl font-semibold">Choose a club to join</h1>
