-- Give wins a 10-day grace period before the 30-day half-life decay
-- kicks in, so players who are busy for a couple of weeks don't watch
-- their score bleed immediately. Formula for the decay factor becomes:
--
--   decay = 0.5 ^ (greatest(0, age_seconds - 10*86400) / (30*86400))
--
-- A match ≤10 days old keeps 100% weight; a 20-day-old match ≈79%; a
-- 40-day-old match = 50%; etc. Mirrors src/features/seeding/logic/computeSuggested.ts.
