-- Expose the per-match seed snapshots (from 20260913170000) via the
-- match-list RPCs so the client-side computeScores can use the frozen
-- opponent seeds instead of the participant's current seed.
--
-- Redefines list_recent_matches and list_unreviewed_matches. Only the
-- participant JSON builder changes — three new keys appended:
--   seed_at_match, singles_seed_at_match, doubles_seed_at_match
